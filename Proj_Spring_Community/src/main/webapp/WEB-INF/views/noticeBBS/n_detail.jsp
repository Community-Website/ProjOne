								...
								<ul id="replyUl" style="margin: 0px;">
									...
									<li id="reDate">
										...
										<p style="display: inline-block; margin: 0px;">
											<c:if test="${!empty uId_Session}">
												<button class="btn" style="background: none; border: 0px; font-size: 13px; color:#b1b1b1; " type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample${cnt }" aria-expanded="false" aria-controls="collapseExample">
													답변달기
												</button>
											</c:if>
										</p>
										<div class="collapse" id="collapseExample${cnt }">
											<div class="card card-body" style="border: 0px; padding: 0px;margin-bottom: 0px;">
												<c:if test="${reply.depth>0}">
													<c:set var="blank" value="0"/>
													<c:forEach var="blank" begin="1" end="${reply.depth}">
														&nbsp;&nbsp;&nbsp;&nbsp;
												...
												<form name="replyFrm2" method="post" id="replyFrm2" action="/noticeBBS/n_reply2">
													<table id="replyTbl">
														<tbody id="replyTblbody">
															<tr>
																<td id="replyUName">
																	...
																	<input type="hidden" name="num" id="num" value="${reply.num}"><!-- 게시판번호 -->
															...
															<tr>
																<td id="replyContent" class="reply">
																	<textarea name="content" id="content" cols="60" wrap="hard"
									...
									<form name="replyFrm3" method="post" id="replyFrm3" action="/noticeBBS/n_updateReply">
										<table id="replyTbl">
											<tbody id="replyTblbody">
												...
												<tr>
													<td id="replyContent"><textarea name="content" id="content"
															cols="60" wrap="hard" >${reply.content }</textarea></td>
												</tr>
											</tbody>
											<tfoot>
												<tr>
