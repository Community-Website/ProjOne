							...
							<ul id="replyUl" style="margin: 0px;">
								...
								<li id="reMenu">
									<div class="btn-group"
										...
										<ul class="dropdown-menu">
											...
											<li><a class="dropdown-item" href="#" id="replydelete">삭제</a></li>
										</ul>
									</div>
								</li>
								...
								<li id="reDate">
									...
									<p style="display: inline-block; margin: 0px;">
										<button class="btn" style="background: none; border: 0px; font-size: 13px; color:#b1b1b1; " type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
											답변달기
										</button>
									</p>
													...
													<tbody id="replyTblbody">
														<tr>
															<td id="replyUName">${uName }(${uId_Session})<input
																...
																name="num" id="num" value="${detail.num}">
															</td>
														</tr>
														<tr>
															<td id="replyContent">
